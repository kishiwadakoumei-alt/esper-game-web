...
通常盤面へ戻る操作であり、終了後の盤面では相手手札、ゲーム外カード、双方の捨て札を
公開する。元は裏向きだった捨て札には「元裏向き」表示を付ける。
...
ESPER宣言と自動決着のどちらでもこの2項目を設定し、再戦初期化時に消去する。
...
| 表向き捨て札 | カード名を公開 | 公開 |
| `game.result` | `null` | 勝者、閲覧者の勝敗、引き分け、決着理由を公開 |
...
ゲーム終了後は例外として、公開済み盤面の確認を目的に双方の捨て札名を表示する。
